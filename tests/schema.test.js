...
describe('Schema', () => {
  it('Schema built using data values', () => {
  ...
  it('Schema built using nested object data values', () => {
    const [shape, values] = schema({
      name: 'Paul',
      age: 21,
      address: {
  ...
  it('Schema built using data types', () => {
    const [shape] = schema({
      name: 'String',
      age: 'Integer',
      today: 'Date'
  ...
  it('Schema built using data prop types', () => {
    const [shape] = schema({
      name: { type: 'String' },
      age: { type: 'Integer' },
      today: { type: 'Date' }
  ...
  it('Schema built when sent a Schema', () => {
    const [shape] = schema({
      name: props.String,
      age: props.Integer,
      today: props.Date
